import { PaletteOptions, ThemeOptions, Palette } from '@mui/material/styles';
import boxShadow from './functions/box-shadow';
const shadows = (palette: Palette): ThemeOptions['boxShadows'] => {
   const { black, coloredShadows, white, tabs } = palette;
   return {
